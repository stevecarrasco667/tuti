    ...
    <div class="w-full lg:max-w-[1600px] lg:mx-auto lg:grid lg:gap-8 pointer-events-none z-40 relative mt-4"
        ...
        <div class="flex-none h-16 flex items-center justify-between px-2 md:px-0 relative w-full pointer-events-none">
            ...
            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none flex items-center justify-center">
                ...
                <div class="absolute w-20 h-20 md:w-24 md:h-24 rounded-full border border-dashed border-tuti-teal/30 animate-spin-slow outer-ring"></div>
                <!-- Inner Ring (Counter-clockwise) -->
                <div class="absolute w-18 h-18 md:w-21 md:h-21 rounded-full border border-dotted border-game-yellow/30 animate-spin-reverse inner-ring"></div>
                
                <!-- Main Glassmorphic Neon Orb -->
                <div class="w-14 h-14 md:w-18 md:h-18 rounded-full
                    ...
                    <span class="text-3xl md:text-4xl font-heading font-black text-tuti-teal drop-shadow-[0_0_10px_rgba(45,212,191,0.8)] neon-orb-text">
                        {{ currentLetter }}
                    </span>
                </div>
            </div>
