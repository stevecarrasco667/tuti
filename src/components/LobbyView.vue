                        ...
                        <div class="bg-panel-base border-[3px] border-white/50 rounded-3xl shadow-game-panel p-4 flex-none">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div
                                    ...
                                    class="relative p-2.5 lg:p-5 rounded-xl lg:rounded-2xl border-[3px] transition-all duration-300 text-center group min-h-[90px] lg:min-h-[110px] flex flex-col items-center justify-center cursor-pointer"
